...
`,_sfc_main$H=defineComponent({__name:"debounce",setup(t){const o=()=>{zztool.debounce(()=>{console.log("防抖")},1e3)};return(n,e)=>{const a=resolveComponent("InputText");return openBlock(),createElementBlock(Fragment,null,[createBaseVNode("button",{onClick:e[0]||(e[0]=r=>o())},"点击"),createVNode(a,{contents:strCode$B,show:!1})],64)}}}),strCode$A=`
zztool.throttle(() => {
    console.log('节流');
}, 1000);
`,_sfc_main$G=defineComponent({__name:"throttle",setup(t){const o=()=>{zztool.throttle(()=>{console.log("节流")},1e3)};return(n,e)=>{const a=resolveComponent("InputText");return openBlock(),createElementBlock(Fragment,null,[createBaseVNode("button",{onClick:o},"点击"),createVNode(a,{contents:strCode$A,show:!1})],64)}}}),strCode$z=`
const data = 10;
...
console.log(isHas)
`,_sfc_main$E=defineComponent({__name:"regIsHas",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$y})}}}),strCode$x=`
...
}`,_sfc_main$D=defineComponent({__name:"regEmail",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$x})}}}),strCode$w=`
...
`,_sfc_main$C=defineComponent({__name:"regPhone",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$w})}}}),strCode$v=`
...
`,_sfc_main$B=defineComponent({__name:"regIdcard",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$v})}}}),strCode$u=`
/**
 * 获取url参数
...
`,_sfc_main$A=defineComponent({__name:"getUrlParam",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$u})}}}),strCode$t=`
  ...
  console.log(param2);
  console.log(param3);
`,_sfc_main$z=defineComponent({__name:"paramformat",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$t})}}}),strCode$s=`
  const obj = { a: 1, b: 2 };
  const arr = [1, 2, 3];
  ...
  console.log(str1);
  console.log(str2);
`,_sfc_main$y=defineComponent({__name:"toString",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$s})}}}),strCode$r=`
  const obj = { a: 1, b: 2 };
  const arr = [1, 2, 3];
  ...
  console.log(str4);
  console.log(str5);
`,_sfc_main$x=defineComponent({__name:"toArray",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$r})}}}),strCode$q=`
  const random = zztool.getRandom(0,100);
  console.log(random)
`,_sfc_main$w=defineComponent({__name:"getRandom",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$q})}}}),strCode$p=`
  const random = zztool.getRandomArray(100,0,100);
  console.log(random)
`,_sfc_main$v=defineComponent({__name:"getRandomArray",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$p})}}}),strCode$o=`
...
`,_sfc_main$u=defineComponent({__name:"getRandomColor",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$o})}}}),money=1e6,strCode$n=`
const money = 1000000;
...
`,_sfc_main$t=defineComponent({__name:"moneyFormat",setup(t){const o=zztool.moneyFormat(money),n=zztool.moneyFormat(money,"~","$");return console.log(o,n),(e,a)=>{const r=resolveComponent("InputText");return openBlock(),createBlock(r,{contents:strCode$n})}}}),strCode$m=`
/**
...
`,_sfc_main$s=defineComponent({__name:"dataEqual",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$m})}}}),strCode$l=`
// false 0 -1 不会为空
  ...
  console.log(data1);
  console.log(data2);
`,_sfc_main$r=defineComponent({__name:"dataEmpty",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$l})}}}),strCode$k=`
  const obj1 = {a:2,b:1,c:{d:1}};
  const obj2 = zztool.deepClone(obj1);
  console.log(obj1 == obj2)
  console.log(obj1 === obj2)
`,_sfc_main$q=defineComponent({__name:"deepClone",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$k})}}}),strCode$j=`
  var data = [
  ...
  console.log(tree)
`,_sfc_main$p=defineComponent({__name:"toTree",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$j})}}}),strCode$i=`
var data = [
...
console.log(datas)
`,_sfc_main$o=defineComponent({__name:"groupBy",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$i})}}}),strCode$h=`
/**
 * 合并数据，取交集/并集/差集/补集
 * @param {*} data1
 * @param {*} data2
...
console.log(data3)
console.log(data4)
`,_sfc_main$n=defineComponent({__name:"dataMerge",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$h})}}}),strCode$g=`
const arr1 = [1,2,3,4,5,5,6];
const data = zztool.uniqueArray(arr1);
console.log(data)
`,_sfc_main$m=defineComponent({__name:"dataUnique",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$g})}}}),strCode$f=`
const arr1 = [1,2,3,4,5,5,'','',6];
console.log(arr1)
const data = zztool.arrayTrim(arr1);
console.log(data)
`,_sfc_main$l=defineComponent({__name:"arrayTrim",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$f})}}}),strCode$e=`
/**
 * 获取日期信息
...
console.log(date)
`,_sfc_main$k=defineComponent({__name:"getDateInfo",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$e})}}}),strCode$d=`
/**
 * 获取日期类型
 * @param date
 * @param type
...
console.log(date)
`,_sfc_main$j=defineComponent({__name:"getDateType",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$d})}}}),strCode$c=`
/**
 * 获取日期
...
`,_sfc_main$i=defineComponent({__name:"getDate",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$c})}}}),strCode$b=`
const days = zztool.getMonthDays(2024,6);
console.log(days);
`,_sfc_main$h=defineComponent({__name:"getMonthDays",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$b})}}}),strCode$a=`
/**
 * 获取两个日期之间的日期
 * @param {*} date
 * @param {*} date1
...
`,_sfc_main$g=defineComponent({__name:"getBetwenDate",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$a})}}}),strCode$9=`
/**
 * 获取某日期的近期天数
...
`,_sfc_main$f=defineComponent({__name:"getDateList",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$9})}}}),strCode$8=`
/**
 * 获取时间段
 * @param {*} start 开始时间
 * @param {*} end 结束时间
...
`,_sfc_main$e=defineComponent({__name:"getTimeStep",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$8})}}}),strCode$7=`
const arr = zztool.getRandomArray(10,0,10);
console.log(zztool.shuffleArray(arr));
console.log(zztool.shuffleArray(arr));
`,_sfc_main$d=defineComponent({__name:"shuffleArray",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$7})}}}),strCode$6=`
const number = zztool.getPercentage(10, 100,2);
console.log(number)
`,_sfc_main$c=defineComponent({__name:"getPercentage",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$6})}}}),strCode$5=`
// dataChangeIndex 不会修改源数据
  ...
  console.log(data3)
`,_sfc_main$b=defineComponent({__name:"dataChangeIndex",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$5})}}}),strCode$4=`
  ...
  console.log(data2)
`,_sfc_main$a=defineComponent({__name:"chunkArray",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$4})}}}),strCode$3=`
/**
 * 获取对应索引的value
 * @param obj 对象
 * @param index 索引
 ...
 */
  ...
  console.log(data);
`,_sfc_main$9=defineComponent({__name:"getSameIndexValue",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$3})}}}),strCode$2=`
/**
...
console.log(data)
`,_sfc_main$8=defineComponent({__name:"dataFind",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$2})}}}),strCode$1=`
/**
 * 获取时间戳
 * @param {*} date
...
`,_sfc_main$7=defineComponent({__name:"getTimeStamp",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$1})}}}),strCode=`
/**
 * 获取索引值
 * 仅适用于对象嵌套，支持以下形式：
 * - 'xxx.xxx.xxx' 形式
...
`,_sfc_main$6=defineComponent({__name:"getValue",setup(t){return(o,n)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode})}}}),dialogProps={modelValue:{type:Boolean,default:!1},width:{type:String,default:"60%"},title:{type:String,default:"提示"},headBg:{type:String,default:"#F1F4F8"},headColor:{type:String,default:"#000"},headShow:{type:Boolean,default:!0},footShow:{type:Boolean,default:!0},bgClose:{type:Boolean,default:!0},leaveText:{type:String,default:"取消"},enterText:{type:String,default:"确定"},leaveColor:{type:String,default:"#000"},enterColor:{type:String,default:"#000"},leaveType:{type:String,default:"primary"},enterType:{type:String,default:"warning"},leaveShow:{type:Boolean,default:!0},enterShow:{type:Boolean,default:!0}},buttonProps={type:{type:String,default:"default"},size:{type:String,default:"default"},shape:{type:String,default:"default"},loading:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1}},addClass=(t,o)=>{let n=[];const e=[!1];for(let a in t)a!="loading"&&(e.includes(t[a])||(t[a]=="default"?n.push(`${o}-${a}-${t[a]}`):t[a]==!0?n.push(`${o}-${a}`):n.push(`${o}-${t[a]}`)));return n},_sfc_main$5=defineComponent({name:"CptButton",props:buttonProps,setup(t){const o=ref(),n=t,e=()=>{o.value.classList=[],o.value.classList.add("cpt-btn","c-pointer",...addClass(n,"cpt"))},a=()=>n.loading;return onMounted(()=>{e()}),onUpdated(()=>{e()}),{buttonRef:o,isLoading:a}}}),_hoisted_1$5={key:0,class:"cpt-loading"};function _sfc_render$1(t,o,n,e,a,r){return openBlock(),createElementBlock("button",{ref:"buttonRef",class:"",style:normalizeStyle(t.isLoading()?"padding-left:30px;pointer-events:none;":"")},[t.isLoading()?(openBlock(),createElementBlock("div",_hoisted_1$5)):createCommentVNode("",!0),createBaseVNode("span",null,[renderSlot(t.$slots,"default",{},void 0)])],4)}const CptButton=_export_sfc(_sfc_main$5,[["render",_sfc_render$1],["__scopeId","data-v-9fc1e5c7"]]),_sfc_main$4=defineComponent({name:"CptDialog",props:dialogProps,emits:["update:modelValue","close","enter"],comments:{CptButton},setup(t,{emit:o}){const n=ref(),e=ref(),a=ref(!1),r=ref(t.width),c=ref(),l=ref();function g(_=""){_=="bg"&&!t.bgClose||(y(),x())}function p(){l.value.style.transition="all 0.3s ease-in-out",l.value.style.top="0%",l.value.style.left="50%",l.value.style.transform="scale(1) translate(-50%, 0)",l.value.removeEventListener("transitionend",p)}function i(){l.value.style.width=0,l.value.style.left=0,l.value.style.top=0,l.value.style.transition="",l.value.style.transform="",l.value.removeEventListener("transitionend",i),a.value=!1,o("update:modelValue",!1)}function s(_,B){a.value=!0,l.value.style.width=r+"px",l.value.style.left=_+"px",l.value.style.top=B+"px",l.value.style.transition="all 1ms ease-in-out",l.value.style.transform="scale(0) translate(0px,0px)",l.value.addEventListener("transitionend",p)}function d(_){a.value||(n.value=_.clientX,e.value=_.clientY)}function m(_){_.keyCode==27&&g()}function h(){document.body.addEventListener("mousedown",d),document.body.addEventListener("keydown",m)}function y(){l.value.style.width=r+"px",l.value.style.left=n.value+"px",l.value.style.top=e.value+"px",l.value.style.transform="scale(0) translate(0px, 0px)",l.value.addEventListener("transitionend",i)}function x(){o("close",!0)}function $(){o("enter",!0)}return h(),onMounted(()=>{}),onUnmounted(()=>{document.body.removeEventListener("mousedown",d),document.body.removeEventListener("keydown",m)}),watch(()=>t.modelValue,_=>{setTimeout(()=>{_&&s(n.value,e.value)})}),{bg:c,content:l,closeDialog:g,BtnEnter:$,prop:t,reset:y}}}),_hoisted_1$4={class:"CptAlert"},_hoisted_2$3={class:"body"},_hoisted_3$2={key:1,class:"btn"};function _sfc_render(t,o,n,e,a,r){const c=resolveComponent("Cpt-button");return openBlock(),createBlock(Teleport,{to:"body"},[withDirectives(createBaseVNode("div",_hoisted_1$4,[createBaseVNode("div",{ref:"bg",class:"bg",onClick:o[0]||(o[0]=l=>t.closeDialog("bg"))},null,512),createBaseVNode("div",{ref:"content",class:"content",style:normalizeStyle({width:t.width})},[t.headShow?(openBlock(),createElementBlock("div",{key:0,class:"head",style:normalizeStyle({background:t.headBg,color:t.headColor}),ref:"head"},toDisplayString(t.title),5)):createCommentVNode("",!0),createBaseVNode("div",_hoisted_2$3,[renderSlot(t.$slots,"default",{},void 0)]),t.footShow?(openBlock(),createElementBlock("div",_hoisted_3$2,[t.leaveShow?(openBlock(),createBlock(c,{key:0,type:t.leaveType,style:normalizeStyle({color:t.leaveColor}),onClick:t.closeDialog},{default:withCtx(()=>[createTextVNode(toDisplayString(t.leaveText),1)]),_:1},8,["type","style","onClick"])):createCommentVNode("",!0),t.enterShow?(openBlock(),createBlock(c,{key:1,type:t.enterType,style:normalizeStyle({color:t.enterColor}),onClick:t.BtnEnter},{default:withCtx(()=>[createTextVNode(toDisplayString(t.enterText),1)]),_:1},8,["type","style","onClick"])):createCommentVNode("",!0)])):createCommentVNode("",!0)],4)],512),[[vShow,t.prop.modelValue]])])}const CptDialog=_export_sfc(_sfc_main$4,[["render",_sfc_render],["__scopeId","data-v-827e09a8"]]),_hoisted_1$3={style:{height:"100%","max-height":"100%"}},_hoisted_2$2=["innerHTML"],_hoisted_3$1=["innerHTML"],_sfc_main$3={__name:"index",setup(t){const o=ref(""),n=ref(""),e=ref(!1),a=ref();onMounted(()=>{g(),p()});const r=i=>{let s="";function d(m){if(m.className==="markdown-body")s=m;else if(m.parentElement.className==="markdown-body")s=m.parentElement;else return d(m.parentElement)}return d(i),s},c=i=>{if(i.button===2){i.preventDefault();const s=r(i.target),d=document.createElement("div");d.innerHTML=s.outerHTML,d.style.width="100%",d.style.height="100%",a.value.innerHTML=d.innerHTML,e.value=!0}};function l(i){i.preventDefault()}onMounted(()=>{window.addEventListener("contextmenu",l)}),onBeforeUnmount(()=>{window.removeEventListener("contextmenu",l)});async function g(){try{const i=await fetch(`https://yourhhh.github.io/zztoolDocument/CHANGELOG.md?timestamp=${zztool.getTimeStamp()}`);if(!i.ok)throw new Error("无法加载 CHANGELOG.md");const s=await i.text();marked.setOptions({highlight:(d,m)=>{const h=HighlightJS.getLanguage(m)?m:"plaintext";return HighlightJS.highlight(d,{language:h}).value}}),o.value=marked.parse(s)}catch(i){o.value=`<p style="color: red;">${i.message}</p>`}}async function p(){try{const i=await fetch(`https://yourhhh.github.io/zztoolDocument/README.md?timestamp=${zztool.getTimeStamp()}`);if(!i.ok)throw new Error("无法加载 README.md");const s=await i.text();marked.setOptions({highlight:(d,m)=>{const h=HighlightJS.getLanguage(m)?m:"plaintext";return HighlightJS.highlight(d,{language:h}).value}}),n.value=marked.parse(s)}catch(i){n.value=`<p style="color: red;">${i.message}</p>`}}return(i,s)=>(openBlock(),createElementBlock(Fragment,null,[createBaseVNode("div",_hoisted_1$3,[s[1]||(s[1]=createBaseVNode("h1",null,"README",-1)),s[2]||(s[2]=createBaseVNode("div",{style:{height:"10px"}},null,-1)),createBaseVNode("div",{class:"md",onMousedown:c},[createBaseVNode("div",{class:"markdown-body",innerHTML:n.value},null,8,_hoisted_2$2)],32),s[3]||(s[3]=createBaseVNode("h1",null,"更新日志",-1)),s[4]||(s[4]=createBaseVNode("div",{style:{height:"10px"}},null,-1)),createBaseVNode("div",{class:"md",onMousedown:c},[createBaseVNode("div",{class:"markdown-body",innerHTML:o.value},null,8,_hoisted_3$1)],32),s[5]||(s[5]=createBaseVNode("div",{style:{height:"10px"}},null,-1))]),createVNode(unref(CptDialog),{modelValue:e.value,"onUpdate:modelValue":s[0]||(s[0]=d=>e.value=d),headShow:!1,enterShow:!1,width:"100%"},{default:withCtx(()=>[createBaseVNode("div",{ref_key:"container",ref:a,style:{height:"calc(100vh - 96px)",overflow:"auto"}}," ceshi ",512)]),_:1},8,["modelValue"])],64))}},comp=Object.freeze(Object.defineProperty({__proto__:null,arrayTrim:_sfc_main$l,chunkArray:_sfc_main$a,dataChangeIndex:_sfc_main$b,dataEmpty:_sfc_main$r,dataEqual:_sfc_main$s,dataFind:_sfc_main$8,dataMerge:_sfc_main$n,dataUnique:_sfc_main$m,debounce:_sfc_main$H,deepClone:_sfc_main$q,error:_sfc_main$I,getBetwenDate:_sfc_main$g,getDate:_sfc_main$i,getDateInfo:_sfc_main$k,getDateList:_sfc_main$f,getDateType:_sfc_main$j,getMonthDays:_sfc_main$h,getPercentage:_sfc_main$c,getRandom:_sfc_main$w,getRandomArray:_sfc_main$v,getRandomColor:_sfc_main$u,getSameIndexValue:_sfc_main$9,getTimeStamp:_sfc_main$7,getTimeStep:_sfc_main$e,getType:_sfc_main$F,getUrlParam:_sfc_main$A,getValue:_sfc_main$6,getVersion:_sfc_main$J,groupBy:_sfc_main$o,index:_sfc_main$3,moneyFormat:_sfc_main$t,paramformat:_sfc_main$z,regEmail:_sfc_main$D,regIdcard:_sfc_main$B,regIsHas:_sfc_main$E,regPhone:_sfc_main$C,shuffleArray:_sfc_main$d,throttle:_sfc_main$G,toArray:_sfc_main$x,toString:_sfc_main$y,toTree:_sfc_main$p},Symbol.toStringTag,{value:"Module"})),_hoisted_1$2={style:{display:"flex"}},_sfc_main$2=defineComponent({__name:"App",setup(t){const o=shallowRef(_sfc_main$3),n=r=>{console.log(`%c${r.title}`,"background: #000000; color: #FFD700; border-radius: 3px 0 0 3px;padding:2px 5px"),o.value=comp[r.com]};onMounted(()=>{});const e=ref(!1),a=ref();return setInterval(()=>{e.value},100),(r,c)=>(openBlock(),createElementBlock(Fragment,null,[createVNode(MoveBtn),createBaseVNode("div",_hoisted_1$2,[createVNode(Menu,{switchs:e.value,bgColor:a.value,onChange:n},null,8,["switchs","bgColor"]),createBaseVNode("div",{style:normalizeStyle([{width:"100%",padding:"10px",transition:"all 0.2s",height:"calc(100vh - 20px)","max-height":"calc(100vh - 20px)",overflow:"auto"},{backgroundColor:a.value}])},[(openBlock(),createBlock(resolveDynamicComponent(o.value)))],4)])],64))}}),App=_export_sfc(_sfc_main$2,[["__scopeId","data-v-cf76e630"]]),_hoisted_1$1={class:"w-full h-full"},_hoisted_2$1={style:{height:"calc(100% - 37px)"},disabled:"",id:"output",class:"w-full",name:""},_sfc_main$1=defineComponent({__name:"output",props:{content:String},setup(t){const o=t,{t:n}=useI18n();return(e,a)=>(openBlock(),createElementBlock("div",_hoisted_1$1,[createBaseVNode("h1",null,toDisplayString(unref(n)("output")),1),createBaseVNode("textarea",_hoisted_2$1,toDisplayString(o.content),1)]))}}),_hoisted_1={style:{display:"flex","flex-direction":"column"},class:"h-full"},_hoisted_2={class:"h-full w-full"},_hoisted_3={class:"w-full h-full",name:"",id:"textarea"},_sfc_main=defineComponent({__name:"inputText",props:{contents:{type:String,default:""},show:{type:Boolean,default:!0}},setup(__props){const props=__props,{t:$t}=useI18n(),start=()=>{const outputDom=document.getElementById("output");outputDom.value="";const dom=document.getElementById("textarea"),value=dom.value,str=zztool.replaceAll(value,"console.log",`var outputDom = document.getElementById('output');
...
//# sourceMappingURL=index-pEcJUP6G.js.map
